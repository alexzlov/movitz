...
;;;    (:cmpl :ebx (:eax #.(movitz::slot-offset 'movitz::movitz-struct 'movitz::name)))
;;;    (:jne '(:sub-program (type-error) (:int 66)))
    ;; type test passed, read slot
    (:load-constant slot-number :ecx)
;;;    (:shrl #.movitz::+movitz-fixnum-shift+ :ecx)
    (#.movitz:*compiler-nonlocal-lispval-read-segment-prefix*
     :movl (:eax (:ecx 1) #.(movitz::slot-offset 'movitz::movitz-struct 'movitz::slot0))
	   :eax)))
...
;;;    (:shrl #.movitz::+movitz-fixnum-shift+ :ecx)
    (#.movitz:*compiler-nonlocal-lispval-write-segment-prefix*
     :movl :eax (:ebx (:ecx 1) #.(movitz::slot-offset 'movitz::movitz-struct 'movitz::slot0)))))
