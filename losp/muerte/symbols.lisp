...
(define-compiler-macro %symbol-global-value (symbol)
  `(memref ,symbol ,(movitz::slot-offset 'movitz:movitz-symbol 'movitz::value)))

(defun %symbol-global-value (symbol)
  (%symbol-global-value symbol))

(define-compiler-macro (setf %symbol-global-value) (value symbol)
  `(setf (memref ,symbol ,(movitz::slot-offset 'movitz:movitz-symbol 'movitz::value))
     ,value))
...
(defun symbol-flags (symbol)
  (etypecase symbol
    (null #.(movitz::enum-value 'movitz::movitz-symbol-flags '(:constant-variable)))
    (symbol
